...
WP Fakeloader is an awesome Preloader based on Fakeloader JS. This is <strong>simple to customize</strong> and super lightweight plugin for wordpress website with some nice <strong>predefined spinner</strong>.
